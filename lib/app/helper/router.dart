...
import 'package:glamgig_user/app/backend/binding/account_binding.dart';
import 'package:glamgig_user/app/backend/binding/account_chat_binding.dart';
import 'package:glamgig_user/app/backend/binding/add_card_binding.dart';
import 'package:glamgig_user/app/backend/binding/add_review_binding.dart';
import 'package:glamgig_user/app/backend/binding/address_binding.dart';
import 'package:glamgig_user/app/backend/binding/address_list_binding.dart';
import 'package:glamgig_user/app/backend/binding/all_categories_binding.dart';
import 'package:glamgig_user/app/backend/binding/app_pages_binding.dart';
import 'package:glamgig_user/app/backend/binding/appointment_detail_binding.dart';
import 'package:glamgig_user/app/backend/binding/booking_binding.dart';
import 'package:glamgig_user/app/backend/binding/cart_binding.dart';
import 'package:glamgig_user/app/backend/binding/categories_binding.dart';
import 'package:glamgig_user/app/backend/binding/categories_list_binding.dart';
import 'package:glamgig_user/app/backend/binding/chat_binding.dart';
import 'package:glamgig_user/app/backend/binding/checkout_binding.dart';
import 'package:glamgig_user/app/backend/binding/choose_location_binding.dart';
import 'package:glamgig_user/app/backend/binding/complaints_binding.dart';
import 'package:glamgig_user/app/backend/binding/contact_us_binding.dart';
import 'package:glamgig_user/app/backend/binding/coupon_binding.dart';
import 'package:glamgig_user/app/backend/binding/edit_profile_binding.dart';
import 'package:glamgig_user/app/backend/binding/filter_binding.dart';
import 'package:glamgig_user/app/backend/binding/find_location_binding.dart';
import 'package:glamgig_user/app/backend/binding/firebase_binding.dart';
import 'package:glamgig_user/app/backend/binding/home_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_categories_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_checkout_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_list_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_packages_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_payment_binding.dart';
import 'package:glamgig_user/app/backend/binding/individual_slot_binding.dart';
import 'package:glamgig_user/app/backend/binding/intro_binding.dart';
import 'package:glamgig_user/app/backend/binding/languages_binding.dart';
import 'package:glamgig_user/app/backend/binding/login_binding.dart';
import 'package:glamgig_user/app/backend/binding/near_binding.dart';
import 'package:glamgig_user/app/backend/binding/new_address_binding.dart';
import 'package:glamgig_user/app/backend/binding/packages_details_binding.dart';
import 'package:glamgig_user/app/backend/binding/payment_binding.dart';
import 'package:glamgig_user/app/backend/binding/product_order_binding.dart';
import 'package:glamgig_user/app/backend/binding/product_order_detail_binding.dart';
import 'package:glamgig_user/app/backend/binding/product_payment_binding.dart';
import 'package:glamgig_user/app/backend/binding/products_binding.dart';
import 'package:glamgig_user/app/backend/binding/products_details_binding.dart';
import 'package:glamgig_user/app/backend/binding/refer_and_earn_binding.dart';
import 'package:glamgig_user/app/backend/binding/register_binding.dart';
import 'package:glamgig_user/app/backend/binding/reset_password_binding.dart';
import 'package:glamgig_user/app/backend/binding/search_binding.dart';
import 'package:glamgig_user/app/backend/binding/selected_services_binding.dart';
import 'package:glamgig_user/app/backend/binding/services_binding.dart';
import 'package:glamgig_user/app/backend/binding/slot_binding.dart';
import 'package:glamgig_user/app/backend/binding/sortby_binding.dart';
import 'package:glamgig_user/app/backend/binding/specialist_binding.dart';
import 'package:glamgig_user/app/backend/binding/splash_binding.dart';
import 'package:glamgig_user/app/backend/binding/stripe_pay_binding.dart';
import 'package:glamgig_user/app/backend/binding/stripe_pay_product_binding.dart';
import 'package:glamgig_user/app/backend/binding/tabs_binding.dart';
import 'package:glamgig_user/app/backend/binding/top_offers_binding.dart';
import 'package:glamgig_user/app/backend/binding/top_packages_binding.dart';
import 'package:glamgig_user/app/backend/binding/top_products_binding.dart';
import 'package:glamgig_user/app/backend/binding/top_specialist_binding.dart';
import 'package:glamgig_user/app/backend/binding/wallet_binding.dart';
import 'package:glamgig_user/app/backend/binding/web_payment_binding.dart';
import 'package:glamgig_user/app/backend/binding/web_product_payment_binding.dart';
import 'package:glamgig_user/app/backend/binding/welcome_binding.dart';
import 'package:glamgig_user/app/view/account.dart';
import 'package:glamgig_user/app/view/account_chat.dart';
import 'package:glamgig_user/app/view/add_card.dart';
import 'package:glamgig_user/app/view/add_review.dart';
import 'package:glamgig_user/app/view/address.dart';
import 'package:glamgig_user/app/view/address_list.dart';
import 'package:glamgig_user/app/view/all_categories.dart';
import 'package:glamgig_user/app/view/app_pages.dart';
import 'package:glamgig_user/app/view/appointment_detail.dart';
import 'package:glamgig_user/app/view/booking.dart';
import 'package:glamgig_user/app/view/cart.dart';
import 'package:glamgig_user/app/view/categories.dart';
import 'package:glamgig_user/app/view/categories_list.dart';
import 'package:glamgig_user/app/view/chat.dart';
import 'package:glamgig_user/app/view/checkout.dart';
import 'package:glamgig_user/app/view/choose_location.dart';
import 'package:glamgig_user/app/view/complaints.dart';
import 'package:glamgig_user/app/view/contact_us.dart';
import 'package:glamgig_user/app/view/coupon.dart';
import 'package:glamgig_user/app/view/edit_profile.dart';
import 'package:glamgig_user/app/view/error.dart';
import 'package:glamgig_user/app/view/filter.dart';
import 'package:glamgig_user/app/view/find_location.dart';
import 'package:glamgig_user/app/view/firebase.dart';
import 'package:glamgig_user/app/view/home.dart';
import 'package:glamgig_user/app/view/individual_categories.dart';
import 'package:glamgig_user/app/view/individual_checkout.dart';
import 'package:glamgig_user/app/view/individual_list.dart';
import 'package:glamgig_user/app/view/individual_packages.dart';
import 'package:glamgig_user/app/view/individual_payment.dart';
import 'package:glamgig_user/app/view/individual_slot.dart';
import 'package:glamgig_user/app/view/intro.dart';
import 'package:glamgig_user/app/view/languages.dart';
import 'package:glamgig_user/app/view/login.dart';
import 'package:glamgig_user/app/view/near.dart';
import 'package:glamgig_user/app/view/new_address.dart';
import 'package:glamgig_user/app/view/packages_details.dart';
import 'package:glamgig_user/app/view/payment.dart';
import 'package:glamgig_user/app/view/product_order.dart';
import 'package:glamgig_user/app/view/product_order_detail.dart';
import 'package:glamgig_user/app/view/product_payment.dart';
import 'package:glamgig_user/app/view/product_stripe_pay.dart';
import 'package:glamgig_user/app/view/products.dart';
import 'package:glamgig_user/app/view/products_details.dart';
import 'package:glamgig_user/app/view/refer_and_earn.dart';
import 'package:glamgig_user/app/view/register.dart';
import 'package:glamgig_user/app/view/reset_password.dart';
import 'package:glamgig_user/app/view/search.dart';
import 'package:glamgig_user/app/view/selected_services.dart';
import 'package:glamgig_user/app/view/services.dart';
import 'package:glamgig_user/app/view/slot.dart';
import 'package:glamgig_user/app/view/sortby.dart';
import 'package:glamgig_user/app/view/specialist.dart';
import 'package:glamgig_user/app/view/splash.dart';
import 'package:glamgig_user/app/view/stripe_pay.dart';
import 'package:glamgig_user/app/view/tabs.dart';
import 'package:glamgig_user/app/view/top_offers.dart';
import 'package:glamgig_user/app/view/top_packages.dart';
import 'package:glamgig_user/app/view/top_products.dart';
import 'package:glamgig_user/app/view/top_specialist.dart';
import 'package:glamgig_user/app/view/wallet.dart';
import 'package:glamgig_user/app/view/web_payment.dart';
import 'package:glamgig_user/app/view/web_product_payment.dart';
import 'package:glamgig_user/app/view/welcome.dart';
